...
function calc() {
  //------------------Calc-----------------------------------------------------------------------------
  //----------------------Modal-Calc------------------------------------------------
  var glazingSection = document.querySelector(".glazing"),
      ...
      popupCalcInputs = popupCalc.getElementsByTagName("input"); // console.log(forma);

  glazingSection.addEventListener("click", function (event) {
  ...
  setValidationCalc(popupCalcInputs); //----------------------Tabs-Calc------------------------------------------------

  var popupCalcBalconIcons = popupCalc.querySelector(".balcon_icons"),
      // родитель картинок
  smallPictures = popupCalc.querySelectorAll(".picture"),
      // маленькие картинки добавить класс do_image_more
  ...
  popupCalcBalconIcons.addEventListener("click", function (event) {
  ...
  popupCalcButton.addEventListener("click", function () {
    var statusMessageInput = document.createElement("div");
  ...
  function closeModalCalc() {
    for (var i = 0; i < closeCalc.length; i++) {
      closeCalc[i].addEventListener('click', function () {
        for (var c = 0; c < allModalCalc.length; c++) {
  ...
  statusMessage.classList.add('status'); //write type window in obj
...
function form() {
  ...
  sendForm();
  document.querySelectorAll('input[name="user_phone"]').forEach(function (item) {
...
function images() {
  var photoSmall = document.querySelectorAll('.photo'),
...
function modals() {
  var btnEngineer = document.querySelector('.popup_engineer_btn'),
...
function tabs() {
  var tabGlazing = document.querySelectorAll('.glazing_block'),
      ...
      decorationInfo = document.querySelectorAll('.decoration_info'); // console.log(decorationInfo);
  ...
  function linkdesactive(c, tabsUrl, activeClass) {
    for (var i = c; i < tabsUrl.length; i++) {
      tabsUrl[i].classList.remove(activeClass); // tabsUrl[i].classList.add(noActive);
    }
  } // linkdesactive(1);
...
function timer() {
  ...
  function getTimeRemaining(endtime) {
    ...
    seconds = Math.floor(t / 1000 % 60), minutes = Math.floor(t / 1000 / 60 % 60), hours = Math.floor(t / 1000 / 60 / 60 % 24);
...
/******/ });
//# sourceMappingURL=bundleOld.js.map